    ...
    Route::middleware(['check.status'])->group(function ()
    {
        ...
        Route::namespace('User')->group(function ()
        {
            ...
            Route::controller('UserController')->group(function ()
            {
                ...
                Route::redirect('twofactor', '/mobile/twofactor')->name('twofactor');
                ...
                Route::redirect('deposit/history', '/mobile/deposit/history')->name('deposit.history');
                // Route::get('transactions', 'transactions')->name('transactions');
                Route::redirect('transactions', '/mobile/transactions')->name('transactions');
            ...
            Route::controller('ProfileController')->group(function ()
            {
                ...
                Route::redirect('profile-setting', '/mobile/profile-setting')->name('profile.setting');
                Route::post('profile-setting', 'submitProfile');
                // Route::get('change-password', 'changePassword')->name('change.password');
                Route::redirect('change-password', '/mobile/change-password')->name('change.password');
            ...
            Route::controller('WithdrawController')->prefix('withdraw')->name('withdraw')->group(function ()
            {
                Route::middleware('kyc')->group(function ()
                {
                    ...
                    Route::redirect('/', '/mobile/withdraw');
                    Route::post('/', 'withdrawStore')->name('.money');
                    // Route::get('preview', 'withdrawPreview')->name('.preview');
                    Route::redirect('preview', '/mobile/withdraw/preview')->name('.preview');
                    Route::post('preview', 'withdrawSubmit')->name('.submit');
                });
                // Route::get('history', 'withdrawLog')->name('.history');
                Route::redirect('history', '/mobile/withdraw/history')->name('.history');
            });
            ...
            Route::controller("TradeController")->name('trade.')->prefix('trade')->group(function ()
            {
                ...
                Route::redirect('wining/log', '/mobile/trade/wining/log')->name('wining.log');
                // Route::get('losing/log', 'losingTradeLog')->name('losing.log');
                Route::redirect('losing/log', '/mobile/trade/losing/log')->name('losing.log');
                // Route::get('draw/log', 'drawTradeLog')->name('draw.log');
                Route::redirect('draw/log', '/mobile/trade/draw/log')->name('draw.log');
                ...
                {
                    return redirect($name ? "/mobile/chart/{$name}" : '/mobile/chart');
                })->name('now');
            });
            ...
            Route::controller("ReferralController")->group(function ()
            {
                ...
                Route::redirect('commissions/history', '/mobile/commissions/history')->name('commissions.log');
                // Route::get('referral/log', 'referralsLog')->name('referral.log');
                Route::redirect('referral/log', '/mobile/referral/log')->name('referral.log');
            });
        });
        ...
        Route::prefix('deposit')->name('deposit.')->controller('Gateway\PaymentController')->group(function ()
        {
            ...
            Route::redirect('manual', '/mobile/deposit/manual')->name('manual.confirm');
