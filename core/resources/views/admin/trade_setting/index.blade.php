            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.01" class="form-control" name="profit_margin" required>
                    </div>
...
<script>
    ...
    (function ($) {
        ...
        $('.editBtn').on('click', function (e) {
            ...
            modal.find("input[name=profit_margin]").val(data.profit_margin);
